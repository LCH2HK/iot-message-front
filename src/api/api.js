...
const getLastlatestTwoList = (params) => getAction('/recentlyAdd/recentlyAdd/list', params)
...
// 项目权限管理
const addPrjPermission = (params) => postAction('/projectPermission/sysProjectPermission/add', params)
const editPrjPermission = (params) => putAction('/projectPermission/sysProjectPermission/edit', params)
const getPrjPermissionList = (params) => getAction('/projectPermission/sysProjectPermission/list', params)

// const deletePermission = (params)=>deleteAction("/sys/permission/delete",params);
// const deletePermissionList = (params)=>deleteAction("/sys/permission/deleteBatch",params);
const queryTreeList = (params) => getAction('/sys/permission/queryTreeList', params)
const queryProjectTreeList = (params) => getAction('/projectPermission/sysProjectPermission/queryTreeList', params)
...
const queryProjectByPrjCode = (params) => getAction('/project/sysProject/queryByPrjCode', params)
