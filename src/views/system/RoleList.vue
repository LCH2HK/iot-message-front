  ...
  <a-card :bordered="false" class="card-area">
    ...
    <div class="table-operator" style="margin-top: 5px">
      ...
      <span class="right-button">
        ...
        <a-button class="default-button" icon="download" @click="handleExportXls('角色信息')">导出</a-button>
      </span>
    ...
    <roleUserDrawer ref="drawerForm" @ok="modalFormOk2"></roleUserDrawer>
  </a-card>
</template>

<script>
import RoleModal from './modules/RoleModal'
import roleUserDrawer from './modules/roleUserDrawer'
...
/deep/.ant-calendar-picker[data-v-7a7b290a] {
  width: 40% !important;
}
</style>
