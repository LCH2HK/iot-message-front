<template>
  ...
  >
    <a-tabs defaultActiveKey="1">
      ...
      <a-tab-pane tab="面型图标" key="1">
        <ul>
          <li
            v-for="icon in icons.faceIcons"
            :key="icon"
            :class="{'active':activeIndex === icon}"
            @click="chooseIcon(icon)"
          >
            <img :src="require(`@/assets/img/icon/${icon}.png`)" :alt="icon" />
          </li>
        </ul>
      </a-tab-pane>
      <a-tab-pane tab="线型图标" key="2">
        <ul>
          <li
            v-for="icon in icons.linearIcons"
            :key="icon"
            :class="{'active':activeIndex === icon}"
            @click="chooseIcon(icon)"
          >
      ...
      <a-tab-pane tab="子菜单svg图标" key="3">
        <ul>
          <li
            v-for="icon in icons.colorfulIcons"
            :key="icon"
            :class="{'active':activeIndex === icon}"
            @click="chooseIcon(icon)"
          >
...
const linearIcons = [
  'project-portal', 'dataBoard', 'bug', 'bulb', 'html', 'line-chart', 'meeting-inline', 'monitor', 'paper-phane', 'project-inline', 'setting-inline', 'task-inline', 'device', 'operation', 'alert'
]
const colorfulIcons = [
  '菜单',
  '储存管理',
