  ...
  data() {
    return {
      ...
      url: {
        ...
        parentDeparts: '/sysdepart/sysDepart/listParentDeparts'
      }
    }
  },
  methods: {
      ...
      this.form.validateFields(err => {
        if (!err) {
          ...
          if (this.userId == null) {
            ...
            let departId = this.departList.length && this.departList.length == 1 ? this.departList[0].value : '',
              url = this.url.parentDeparts + '?departId=' + departId,
              params = {}
