<template>
  <a-row :gutter="10">
    <a-col :md="leftColMd" :sm="24" style>
      <a-card :bordered="false">
        ...
        <div class="table-operator">
          ...
          <span class="right-button">
            ...
            <a-button class="default-button" icon="download" @click="handleExportXls">导出</a-button>
            <a-button class="default-button" icon="reload" @click="loadReset">重置</a-button>
          </span>
        </div>
        ...
        <div style="margin-top: 15px">
          ...
          >
            <span slot="action" slot-scope="text, record">
              <a @click="handleOpen(record)">查看用户</a>
    ...
    <a-col :md="rightColMd" :sm="24">
      <a-card :bordered="false">
        ...
        <div class="table-operator" :md="24" :sm="24">
          <a-button @click="handleAdd2" type="primary" icon="plus" style="margin-right:8px;">用户录入</a-button>
        ...
        <Select-User-Modal ref="selectUserModal" @selectFinished="selectOK" :roleId="currentRoleId"></Select-User-Modal>
...
import JSelectUserNewModal from './modules/JSelectUserNewModal'
...
export default {
  ...
  methods: {
    ...
    onSelectChange1 (selectedRowKeys, selectionRows) {
      ...
      this.selectedRole = Object.assign({}, selectionRows[0])
    ...
    selectOK (data) {
      console.log('roleuserList:selectOk()被调用')
