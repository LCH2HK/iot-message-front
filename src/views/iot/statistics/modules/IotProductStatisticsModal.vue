  ...
  >
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-row :gutter="24">
          <a-col :md="12" :sm="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="产品id">
              <a-input
                placeholder="请输入产品id"
          ...
          <a-col :md="12" :sm="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="设备分组id">
              <a-input
          ...
          <a-col :md="12" :sm="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="历史数据表">
              <a-input
                placeholder="请输入历史数据表"
                v-decorator="['historyTable', {}]"
                :disabled="this.nodeId != '' && this.nodeId != 'UserTask_0' || this.title == '查看'"
              />
            </a-form-item>
          </a-col>
          <a-col :md="12" :sm="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="统计数据源">
              <a-input
                placeholder="请输入统计数据源"
                v-decorator="['statisticsDb', {}]"
                :disabled="this.nodeId != '' && this.nodeId != 'UserTask_0' || this.title == '查看'"
              />
            </a-form-item>
          </a-col>
          <a-col :md="12" :sm="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="统计数据表">
              <a-input
                placeholder="请输入统计数据表"
                v-decorator="['statisticsTable', {}]"
                :disabled="this.nodeId != '' && this.nodeId != 'UserTask_0' || this.title == '查看'"
              />
            </a-form-item>
          </a-col>
          ...
          <a-col :md="12" :sm="8">
            <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="统计频率">
              <a-input
                placeholder="请输入统计频率"
...
export default {
  name: 'IotProductStatisticsModal',
  //组件应用定义
  components: {
    JDictSelectTag,
    JSelectUserNew
  ...
  data() {
    return {
      ...
      validatorRules: {},
      url: {
        add: 'http://localhost:8081/ecidi-cmp/statistics/iotProductStatistics/add',
        edit: 'http://localhost:8081/ecidi-cmp/statistics/iotProductStatistics/edit',
        //上传组件地址
