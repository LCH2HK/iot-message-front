    ...
    export default {
        ...
        data () {
            return {
                ...
                url: {
                    add: "/sys/projectRole/add",
                    edit: "/sys/projectRole/edit",
                },
            }
        },
        // 钩子函数
        ...
        methods: {
            ...
            handleOk () {
                console.log('enter the handle ok method');
                const that = this;
                // 触发表单验证
                this.form.validateFields((err, values) => {
                    if (!err) {
                        ...
                        formData.corpCode=this.$store.getters.userInfo.corpCode;
