      ...
      <a-form :form="form">
        ...
        <a-form-item
          ...
          <a-input type="password" @blur="handleConfirmBlur" placeholder="请确认新密码"
                   v-decorator="[ 'confirmpassword', validatorRules.confirmpassword]" size="large"/>
        </a-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        url: '/sys/user/changPasswordByPhone',
        username: '',
        phone: '',
        identifyCode: ''
      }
      ...
      handleOk() {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            let params = Object.assign({ phone: this.phone, identifyCode: this.identifyCode }, values)
