<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('主表配置')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <codegenerOnetomanyFlow-modal ref="modalForm" @ok="modalFormOk"/>
...
<script>
  ...
  import CodegenerOnetomanyFlowModal from './modules/CodegenerOnetomanyFlowModal'
  import {initDictOptions, filterDictText} from '@/components/dict/JDictSelectUtil'
  import { httpAction } from '@/api/manage'

  export default {
    name: "CodegenerOnetomanyFlowList",
    mixins: [CmpListMixin],
    components: {
      CodegenerOnetomanyFlowModal
    },
    data () {
      
      return {
        dbnames:[],
        description: '主表配置管理页面',
        // 表头
        columns: [
          {
            title: '序号',
        ...
        // 请求参数
    	url: {
              list: "/codegenerOnetomanyFlow/codegenerOnetomanyFlow/list",
              delete: "/codegenerOnetomanyFlow/codegenerOnetomanyFlow/delete",
              deleteBatch: "/codegenerOnetomanyFlow/codegenerOnetomanyFlow/deleteBatch",
              exportXlsUrl: "codegenerOnetomanyFlow/codegenerOnetomanyFlow/exportXls",
              importExcelUrl: "codegenerOnetomanyFlow/codegenerOnetomanyFlow/importExcel",
