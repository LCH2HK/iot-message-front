     ...
     <a-row :gutter="24" v-if="leftSearchVisible2">
      ...
      <a-tabs v-model="activeKey" @change="handleChangeTabs">
          <a-tab-pane tab="子表配置" :key="refKeys[0]" :forceRender="true">
            <j-editable-table
              :ref="refKeys[0]"
              :loading="codegenerOnetomanyFlowDetailTable.loading"
              :columns="codegenerOnetomanyFlowDetailTable.columns"
              :dataSource="codegenerOnetomanyFlowDetailTable.dataSource"
              :maxHeight="300"
              :rowNumber="true"
              :rowSelection="true"
              :actionButton="true"/>
...
<script>
  ...
  export default {
    name: 'CodegenerOnetomanyFlowModal',
    ...
    data() {
      return {
        ...
        attachment: [],
        refKeys: ['codegenerOnetomanyFlowDetail', ],
        activeKey: 'codegenerOnetomanyFlowDetail',
        // 子表配置
        codegenerOnetomanyFlowDetailTable: {
          loading: false,
          dataSource: [],
          columns: [
            {
        ...
        url: {
          add: "/codegenerOnetomanyFlow/codegenerOnetomanyFlow/add",
          edit: "/codegenerOnetomanyFlow/codegenerOnetomanyFlow/edit",
          codegenerOnetomanyFlowDetail: {
            list: '/codegenerOnetomanyFlow/codegenerOnetomanyFlow/queryCodegenerOnetomanyFlowDetailByMainId'
          },
    ...
    methods: {
      ...
      editAfter(record) {
        ...
        this.$nextTick(() => {
          this.form.setFieldsValue(
            ...
            'departNames',
            'orgCodes'))
          this.model.templatename = "onetomany-flow"
        ...
        if (this.model.id) {
          ...
          this.requestSubTableData(this.url.codegenerOnetomanyFlowDetail.list, params, this.codegenerOnetomanyFlowDetailTable)
        }
        // 初始化选人组件字段
      ...
      classifyIntoFormData(allValues) {
        ...
        return {
          ...main, // 展开
          codegenerOnetomanyFlowDetailList: allValues.tablesValue[0].values,
        }
      },
      request(formData) {
      ...
      handleGenerate(){
        ...
        this.getAllTable().then(tables => {
          ...
          if (typeof this.classifyIntoFormData !== 'function') {
            ...
            let list = formData.codegenerOnetomanyFlowDetailList;
            ...
            let formData2 = {"mainTableVo":{
                                ...
                                'departmentField':formData.departmentField,
      ...
      gettablenames(dbName){
        ...
        httpAction(httpurl,qs.stringify(data),method).then(res=>{
          if(res.success){
            ...
            this.codegenerOnetomanyFlowDetailTable.columns[0].options=mm;
