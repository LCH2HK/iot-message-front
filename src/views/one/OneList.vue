<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('单表不带流程')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <one-modal ref="modalForm" @ok="modalFormOk"></one-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
		...
		url: {
          list: "/one/one/list",
          delete: "/one/one/delete",
          deleteBatch: "/one/one/deleteBatch",
          exportXlsUrl: "one/one/exportXls",
          importExcelUrl: "one/one/importExcel",
