    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-row :gutter="24">
        ...
        <a-form-item
          ...
          label="选房区名称">
          <a-input placeholder="请输入选房区名称" v-decorator="['areaName', {}]" />
        </a-form-item>
        </a-col>
        <a-col :md="12" :sm="8">
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="楼盘数量">
          <a-input placeholder="请输入楼盘数量" v-decorator="['communityAmount', {}]" />
        </a-form-item>
        </a-col>
        <a-col :md="12" :sm="8">
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="单人选房时长">
          <a-input placeholder="请输入单人选房时长" v-decorator="['selectionTime', {}]" />
        </a-form-item>
        </a-col>
        <a-col :md="12" :sm="8">
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="省">
          <a-input placeholder="请输入省" v-decorator="['areaProvince', {}]" />
        </a-form-item>
        </a-col>
        <a-col :md="12" :sm="8">
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="市">
          <a-input placeholder="请输入市" v-decorator="['areaCity', {}]" />
        </a-form-item>
        </a-col>
        <a-col :md="12" :sm="8">
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="区">
          <a-input placeholder="请输入区" v-decorator="['areaCounty', {}]" />
        </a-form-item>
        </a-col>
        <!--<a-col :md="12" :sm="8">-->
        <!--<a-form-item-->
          ...
          <!--:wrapperCol="wrapperCol"-->
          <!--label="乡">-->
          <!--<a-input placeholder="请输入乡" v-decorator="['areaTownship', {}]" />-->
        <!--</a-form-item>-->
        <!--</a-col>-->
        <!--<a-col :md="12" :sm="8">-->
        <!--<a-form-item-->
          ...
          <!--:wrapperCol="wrapperCol"-->
          <!--label="村">-->
          <!--<a-input placeholder="请输入村" v-decorator="['areaVillage', {}]" />-->
        <!--</a-form-item>-->
        <!--</a-col>-->
        <!--<a-col :md="12" :sm="8">-->
        <!--<a-form-item-->
          ...
          <!--:wrapperCol="wrapperCol"-->
          <!--label="组">-->
          <!--<a-input placeholder="请输入组" v-decorator="['areaGroup', {}]" />-->
        <!--</a-form-item>-->
        <!--</a-col>-->
     </a-row>
     <!--<a-row :gutter="24">-->
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/houseChoose/houseChooseArea/add",
          edit: "/houseChoose/houseChooseArea/edit",
          //上传组件地址
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'areaName','communityAmount','selectionTime','areaProvince','areaCity','areaCounty','areaTownship','areaVillage','areaGroup'))
