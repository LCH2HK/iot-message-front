    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-row :gutter="24">
        ...
        <a-form-item
          ...
          label="选房区域 外键ID">
          <a-input placeholder="请输入选房区域 外键ID" v-decorator="['chooseAreaId', {initialValue :this.$route.query.areaId}]" />
        </a-form-item>
        </a-col>
        <a-col :md="12" :sm="8" style="display: none">
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="楼盘外键">
          <a-input placeholder="请输入楼盘外键" v-decorator="['communityId', {initialValue :this.$route.query.communityId}]" />
        </a-form-item>
        </a-col>
        <a-col :md="12" :sm="8">
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="期号">
          <a-input-number placeholder="请输入期号" v-decorator="[ 'periodsNumber', {}]" style="width: 100%;"/>
        </a-form-item>
        </a-col>
        <a-col :md="12" :sm="8">
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="幢号">
          <a-input-number placeholder="请输入幢号" v-decorator="[ 'buildingNumber', {}]" style="width: 100%;" />
        </a-form-item>
        </a-col>
        <a-col :md="12" :sm="8">
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="总楼层">
          <a-input-number placeholder="请输入总楼层" v-decorator="['floorsAmount', {}]" style="width: 100%;" />
        </a-form-item>
        </a-col>
        <a-col :md="12" :sm="8">
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="单元数">
          <a-input-number placeholder="请输入单元数" v-decorator="['unitsAmount', {}]" style="width: 100%;" />
        </a-form-item>
        </a-col>
        <a-col :md="12" :sm="8">
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="每单元户数">
          <a-input-number placeholder="请输入每单元户数" v-decorator="[ 'householdsInUnit', {}]" style="width: 100%;" />
        </a-form-item>
        </a-col>
     </a-row>
	    <a-row :gutter="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/houseChoose/houseChooseBuilding/add",
          edit: "/houseChoose/houseChooseBuilding/edit",
          //上传组件地址
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'chooseAreaId','communityId','periodsNumber','buildingNumber','floorsAmount','unitsAmount','householdsInUnit'))
