<template>
  <a-card :bordered="false">
    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="24">
          ...
          <a-col :md="5" :sm="8">
            <a-form-item label="录入人用户名">
              <a-input v-model="queryParam.inputerName"></a-input>
            </a-form-item>
          </a-col>
          <a-col :md="5" :sm="8">
            <a-form-item label="录入人姓名">
              <a-input v-model="queryParam.inputerFullname"></a-input>
            </a-form-item>
          </a-col>
        <template v-if="toggleSearchStatus">
          <a-col :md="5" :sm="8">
            <a-form-item label="消息通知方式">
              <a-input v-model="queryParam.notifyMethod"></a-input>
            </a-form-item>
          </a-col>
        </template>
        <template v-if="toggleSearchStatus">
          <a-col :md="5" :sm="8">
            <a-form-item label="楼内人数">
              <a-input v-model="queryParam.buildingPeopleNumber"></a-input>
            </a-form-item>
          </a-col>
        </template>
        <template v-if="toggleSearchStatus">
          <a-col :md="5" :sm="8">
            <a-form-item label="进入总数">
              <a-input v-model="queryParam.inbuildingCount"></a-input>
            </a-form-item>
          </a-col>
        </template>
        <template v-if="toggleSearchStatus">
          <a-col :md="5" :sm="8">
            <a-form-item label="离开总数">
              <a-input v-model="queryParam.outbuildingCount"></a-input>
            </a-form-item>
          </a-col>
        </template>
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('物联网网络通信测试')">导出</a-button>
    ...
    <!-- 表单区域 -->
    <iotTest-modal ref="modalForm" @ok="modalFormOk"></iotTest-modal>
  </a-card>
</template>

<script>
  import IotTestModal from './modules/IotTestModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        columns: [
          {
           ...
           },
           {
             title: '楼内人数',
             align:"center",
             dataIndex: 'buildingPeopleNumber'
           },
           {
             title: '进入总数',
             align:"center",
             dataIndex: 'inbuildingCount'
           },
           {
             title: '离开总数',
             align:"center",
             dataIndex: 'outbuildingCount'
           },
          {
            title: '操作',
            dataIndex: 'action',
		...
		url: {
          list: "/iotTest/iotTest/list",
          delete: "/iotTest/iotTest/delete",
          deleteBatch: "/iotTest/iotTest/deleteBatch",
          exportXlsUrl: "iotTest/iotTest/exportXls",
          importExcelUrl: "iotTest/iotTest/importExcel",
       },
       collapsed: false,
    }
  },
