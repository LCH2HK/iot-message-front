    ...
    <a-spin :spinning="confirmLoading">
      ...
      <a-row :gutter="24">
        ...
        <!-- <a-col :md="12" :sm="8">
          ...
          :wrapperCol="wrapperCol"
          label="部门字段">
            <j-select-multiple placeholder="请选择部门字段" v-model="jselectMultiple2.value" :options="jselectMultiple2.options"/>
          </a-form-item>
        </a-col> -->
        <a-col :md="12" :sm="8">
    ...
    data () {
      return {
        ...
        validatorRules:{
          ...
          userNames: {rules: [{ required: true, message: '请输入用户名！'}]},
          fullNames: {rules: [{ required: true, message: '请输入真实名！'}]},
          departNames: {rules: [{ required: true, message: '请输入部门名称！'}]},
          orgCodes: {rules: [{ required: true, message: '请输入部门编码！'}]},
        },
        url: {
          add: "/oneFlow/oneFlow/add",
          edit: "/oneFlow/oneFlow/edit",
          getdbname:"/codegenerate/getdbname",
          gettable:"/codegenerate/gettable",
          getparam:"/codegenerate/getparam",
          code:"codegenerate/one",
          dicCodeList: "/sys/dict/list"
        },
      }
    },
    created () {
      ...
      edit (record) {
        ...
        this.$nextTick(() => {
          this.form.setFieldsValue(
            ...
            'departNames',
            'orgCodes'))
          this.model.templatename = "one-flow"
      ...
      handleOk () {
        ...
        this.form.validateFields((err, values) => {
          if (!err) {
            ...
            // let arr = formData.userNames.split(",");
            // let arr1 = formData.fullNames.split(",");
            // let arr2 = [];
