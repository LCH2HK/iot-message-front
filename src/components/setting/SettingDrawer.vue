        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div class="setting-drawer-index-blockChecbox">
            ...
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleLayout('topsidemenu')">
                <img src="https://gw.alipayobjects.com/zos/rmsportal/JopDzEhOqwOjeNTXkoje.svg" alt="topsidemenu">
                <div class="setting-drawer-index-selectIcon" v-if="layoutMode === 'topsidemenu'">
                  <a-icon type="check"/>
                </div>
              </div>
            </a-tooltip>
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div>
            <a-list :split="false">
              ...
              <a-list-item>
                <a-switch slot="actions" size="small" :defaultChecked="enableI18n" @change="onEnableI18n" />
                <a-list-item-meta>
                  <div slot="title">国际化</div>
                </a-list-item-meta>
              </a-list-item>
            </a-list>
          </div>
...
export default {
  ...
  mounted () {
    ...
    if (this.enableI18n !== config.enableI18n) {
      this.$store.dispatch('ToggleI18n', this.enableI18n)
    }
  },
  methods: {
    /* showDrawer() {
    ...
    onEnableI18n (enableI18n) {
      this.$store.dispatch('ToggleI18n', enableI18n)
    }
  }
}
</script>
